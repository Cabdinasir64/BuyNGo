                ...
                <nav className="p-4 space-y-2 flex-grow">
                    ...
                    <div className="relative">
                        <motion.button
                            ...
                            className={`w-full text-left px-4 py-3 rounded-lg transition-colors duration-150 ease-in-out font-medium flex items-center gap-2 ${activeTab.startsWith("address")
                                ? "bg-primary text-white hover:bg-primary/80"
                                : "hover:bg-primary"
                                }`}
                            layout
                        ...
                        >
                            ...
                            <span>Addresses</span>
                            <FaChevronDown
                                className={`ml-auto text-sm transition-transform ${isAddressOpen ? "rotate-180" : ""}`}
                            />
                        </motion.button>
                        ...
                        {isAddressOpen && (
                            <div className="ml-2 mt-1 space-y-1">
                                <motion.button
                                    ...
                                    className={`w-full text-left px-4 py-2 rounded-lg transition-colors duration-150 ease-in-out font-medium flex items-center gap-2 ${activeTab === "add_address"
                                ...
                                <motion.button
                                    onClick={() => {
                                        setActiveTab("all_address");
                                        setIsSidebarOpen(false);
                                    }}
                                    className={`w-full text-left px-4 py-2 rounded-lg transition-colors duration-150 ease-in-out font-medium flex items-center gap-2 ${activeTab === "all_address"
                                        ? "bg-primary/80 text-white"
                                        : "hover:bg-primary/50"
                                        }`}
                                >
