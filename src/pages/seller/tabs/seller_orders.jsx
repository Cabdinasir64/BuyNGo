                ...
                <div className="space-y-4">
                    {orders.map(order => (
                        <motion.div
                            ...
                            className={`border rounded-lg overflow-hidden ${order.status === 'confirmed' ? 'bg-green-50 border-green-200' : order.status === 'cancelled' ? 'bg-red-50 border-red-200' : 'bg-white border-gray-200'}`}
                        >
