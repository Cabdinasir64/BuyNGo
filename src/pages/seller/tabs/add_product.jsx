...
const AddProduct = ({ initialProduct, onSave, onCancel, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!product.properties.length) newErrors.properties = "At least one property is required";
    ...
    return (
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-6 mt-2">
                {/* Product Name */}
                <div>
                    <label htmlFor="productName" className="block text-sm font-medium text-dark-muted mb-1">
                        Product Name *
                    </label>
                    <input
                        id="productName"
                ...
                {/* Product Price */}
                <div>
                    <label htmlFor="productPrice" className="block text-sm font-medium text-dark-muted mb-1">
                        Price *
                    </label>
                    <input
                        id="productPrice"
                ...
                <div>
                    <label htmlFor="productCategory" className="block text-sm font-medium text-dark-muted mb-1">
                        Category *
                    </label>
                    <select
                        id="productCategory"
                    ...
                    >
                        ...
                        {categoriesData.map((mainCat) => (
                            <optgroup label={mainCat.name} key={mainCat.name} className="font-semibold">
                                {mainCat.subcategories.map((subCat) => (
                                    <option value={subCat} key={subCat} className="text-dark-muted">
                                        {subCat}
                                    </option>
                                ))}
                            </optgroup>
                ...
                {/* Product Description */}
                <div>
                    <label htmlFor="productDescription" className="block text-sm font-medium text-dark-muted mb-1">
                        Description *
                    </label>
                    <textarea
